...
- **Only the narration text leaves your machine.** agentic-demo sends it to the voice provider; the recording and the video stay local. If you use a cloud browser, its provider sees the pages too.
